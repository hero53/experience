        ...
        <header>
            <div class="d-flex flex-column flex-md-row align-items-center pb-3 mb-4 border-bottom">
                ...
                <nav class="d-inline-flex mt-2 mt-md-0 ms-md-auto">
                    <a class="me-3 py-2 text-dark text-decoration-none" href="#">Enregistrement</a>
                    <a class="me-3 py-2 text-dark text-decoration-none" href="#">Connexion</a>
                    <a class="me-3 py-2 text-dark text-decoration-none" href="#">Profile</a>
                    <a class="py-2 text-dark text-decoration-none" href="#">Déconnexion</a>
                </nav>
            </div>
        </header>
    </div>
